    ...
    <header className="sticky top-0 z-30 border-b border-black/5 bg-[rgba(247,243,238,0.85)] backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-3">
          <Link href="/" className="flex h-11 w-11 items-center justify-center rounded-2xl bg-[#fb923c] text-lg font-semibold text-white shadow-[0_14px_40px_rgba(251,146,60,0.28)] hover:scale-105 transition-transform">
            P
          </Link>
          <div>
        ...
        <div className="flex items-center gap-4">
          <div className="hidden rounded-full border border-black/5 bg-white/80 px-4 py-2 text-sm text-[#5d4a3e] shadow-[0_10px_30px_rgba(34,23,15,0.06)] lg:block">
