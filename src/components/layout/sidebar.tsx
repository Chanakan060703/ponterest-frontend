...
export function Sidebar() {
  ...
  return (
    <>
      <nav className="fixed left-0 top-0 z-40 flex h-screen w-20 flex-col items-center border-r border-black/5 bg-white py-8">
        <Link href="/" className="mb-10 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#fb923c] text-lg font-semibold text-white shadow-[0_14px_40px_rgba(251,146,60,0.28)] hover:scale-105 transition-transform">
